    ...
    <DomainProvider domain={MockDomain()}>
      <div className="home">
        ...
        <div className="m-4 p-8  rounded-lg backdrop-blur-md bg-white bg-opacity-20  flex justify-between">
          ...
          >
            {name} <FontAwesomeIcon icon={faFile} />{" "}
          </div>
...
function DomainDetails() {
  ...
  let inner = null;
  let [display_edit_registrant, setDisplayEditRegistrant] =
    React.useState(false);
  let [display_extend_expiration, setDisplayExtendExpiration] =
    React.useState(false);
          ...
          <>
            <ul className="grid grid-flow-row">
              ...
              <li className="grid grid-flow-row">
                <div className="flex justify-between">
                  <div className="grid grid-flow-col gap-4">
                    ...
                    <div
                      ...
                      onClick={() => {
                        navigator.clipboard.writeText(domain.registrant_hash);
                        alert("copied to clipboard");
                      }}
                    >
                      {domain.registrant_hash} <FontAwesomeIcon icon={faFile} />
                    </div>
                  </div>
                  <div>
                    <button
                ...
                <div
                  className="grid grid-flow-row gpa-1 justify-center items-center m-8 "
                  style={{
                    display:
                      name.startsWith("own") && display_edit_registrant
                        ? "grid"
                        : "none",
                  }}
                >
                  <input
                    className="bg-white rounded-lg p-1 text-black min-w-[40em] m-4"
                  ...
                  <div className="flex justify-between m-4">
                    <button
                      className="btn-thin"
                      onClick={() => {
                        setDisplayEditRegistrant(false);
                      }}
                    >
                      Ok
                    </button>
              ...
              <li className="grid grid-flow-row">
                ...
                <div
                  ...
                  style={{
                    display:
                      name.startsWith("own") && display_extend_expiration
                        ? ""
                        : "none",
                  }}
                >
  ...
  return (
    <div className="m-4 p-4 rounded-lg backdrop-blur-md bg-white bg-opacity-20 ">
      {inner}
    </div>
  );
}
