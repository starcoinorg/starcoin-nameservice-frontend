...
export function mockName(): string {
    let name = Random.first().toLowerCase() + Random.string("abcdefghijklmnopqrstuvwxyz" + "123456789", 0, 10);
    return name;
}
...
function mockDomainRecord(): DomainRecord {
    let record = {
        contents: mockName(),
        text_record: [{ id: 0, text: "record 0" }, { id: 1, text: "record 1" }, { id: 2, text: "record 2" }, { id: 3, text: "record 3" }, { id: 4, text: "record 4" }, { id: 5, text: "record 5" }, { id: 6, text: "record 6" }, { id: 7, text: "record 7" }, { id: 8, text: "record 8" }, { id: 9, text: "record 9" }],
    }
    return record;
}
